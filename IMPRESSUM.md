...
### ℹ️ How does #swissguesser work?

We tweet an aerial photo of Switzerland. Reply as soon as possible with your guess of the municipality or place shown in the image. The fastest correctanswer scores 5, 10 or 20 points, slower ones score a fifth of that.

### ℹ️ Your privacy is important.

We store your Twitter handle, your all-time and 30-day #swissguesser score and rank on our public leaderboard at https://swissguesser.github.io/leaderboard. If you don't want that, please let us know in a Direct Message to @swissguesser indicating your Twitter handle. See Terms Of Service and Privacy Statement below.

### ℹ️ How will you know if your #swissguesser answer was correct?

If you were the first to submit a correct answer, @swissguesser will mention and congratulate you. If you were correct but not the fastest, we will like your answer tweet. If there is no interaction, you were off.

### ℹ️ You want to know your current score?

Simply go to the leaderboard at https://swissguesser.github.io/leaderboard. Or ask @swissguesser by tweeting «score» (or more politely, for example: «What is my score, please?» 😉) at us. We'll do the calculations and send you your current rank and stats."

### ℹ️ How do we decide on how many points to award per challenge?

We decide on this based on image difficulty, which in turn is defined by what is shown in the image. We award 5, 10 or 20 points per challenge – you can (try and) bribe us with chocolate 😉'
...
### Datenschutzerklärung für GithubPages
...
Authors
Ralph Straumann ([Twitter](https://twitter.com/rastrau), [GitHub](https://github.com/rastrau)) and David Oesch ([Twitter](https://twitter.com/davidoesch), [GitHub](https://github.com/davidoesch))
